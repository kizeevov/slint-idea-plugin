...
public class SlintBinaryExpressionImpl extends SlintExpressionImpl implements SlintBinaryExpression {

  public SlintBinaryExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SlintOperators getOperators() {
    return findNotNullChildByClass(SlintOperators.class);
  }
