...
public class SlintMathematicalOperatorsImpl extends SlintElementImpl implements SlintMathematicalOperators {

  public SlintMathematicalOperatorsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SlintVisitor visitor) {
    visitor.visitMathematicalOperators(this);
  }
