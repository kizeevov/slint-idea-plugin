...
public class SlintAlignmentExpressionImpl extends SlintExpressionImpl implements SlintAlignmentExpression {

  public SlintAlignmentExpressionImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SlintVisitor visitor) {
    visitor.visitAlignmentExpression(this);
  }
