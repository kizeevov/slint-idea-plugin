...
public class SlintStructFieldDeclarationBlockImpl extends SlintElementImpl implements SlintStructFieldDeclarationBlock {

  public SlintStructFieldDeclarationBlockImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SlintVisitor visitor) {
    visitor.visitStructFieldDeclarationBlock(this);
  }
